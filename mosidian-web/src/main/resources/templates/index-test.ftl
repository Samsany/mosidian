            ...
            <div class="row">
                <div class="Grid"
                    ...
                    <div style="width: 260px;height: 350px;">
                        <img src="img/business/business1.png"
                        ...
                        <hr/>
                        <p style="font-size: 12px;text-align: center">满足初创需求</p>
                        <hr/>
                        <p style="font-size: 13px">初创公司的核心不是技术能力，提供满足需求的ERP等心选产品。</p>
                    </div>
                    <div style="width: 260px;height: 350px;">
                        <img src="img/business/business2.png"
                             style="display:block; margin:0 auto;width:100px; height:100px;background-size: cover;-webkit-clip-path: polygon(50% 0, 100% 25%, 100% 75%, 50% 100%, 0 75%, 0 25%);clip-path: polygon(50% 0, 100% 25%, 100% 75%, 50% 100%, 0 75%, 0 25%);">
                        <h5 style="text-align: center">规范管理员工</h5>
                        <hr/>
                        <p style="font-size: 12px;text-align: center">规范管理员工</p>
                        <hr/>
                        <p style="font-size: 13px">通过系统规范员工行为，避免损害公司利益的行为。</p>
                    </div>
                    <div style="width: 260px;height: 350px;">
                        <img src="img/business/business3.png"
                             style="display:block; margin:0 auto;width:100px; height:100px;background-size: cover;-webkit-clip-path: polygon(50% 0, 100% 25%, 100% 75%, 50% 100%, 0 75%, 0 25%);clip-path: polygon(50% 0, 100% 25%, 100% 75%, 50% 100%, 0 75%, 0 25%);">
                        <h5 style="text-align: center">随时随地移动办公</h5>
                        <hr/>
                        <p style="font-size: 12px;text-align: center">成为用户体验最佳的互联网金融平台</p>
                        <hr/>
                        <p style="font-size: 13px">随时随地管理企业需求，打通企业管理的“人财货客”全链条。</p>
                    </div>
                    <div style="width: 260px;height: 350px;">
                        <img src="img/business/business4.png"
                             style="display:block; margin:0 auto;width:100px; height:100px;background-size: cover;-webkit-clip-path: polygon(50% 0, 100% 25%, 100% 75%, 50% 100%, 0 75%, 0 25%);clip-path: polygon(50% 0, 100% 25%, 100% 75%, 50% 100%, 0 75%, 0 25%);">
                        <h5 style="text-align: center">即时业务洞察</h5>
                        <hr/>
                        <p style="font-size: 12px;text-align: center">成为用户体验最佳的互联网金融平台</p>
                        <hr/>
                        <p style="font-size: 13px">简易搭建专业水准的可视化大屏，进行即时业务洞察。</p>
                    </div>
                </div>
            </div>
        </div>
...
<!--====== 合作伙伴 PART START ======-->
<div class="brand pt-40 pb-40" style="background-color: #0b0b0b">
    <div class="container">
...
<div data-scroll-index="4" class="pb-40">
    <div class="col-lg-12">
        ...
        <div id="safeguardA" class="text-center col-lg-8 offset-lg-2">
            <h3>A客户端·保障协议</h3>
            <a class="btn" data-toggle="modal" data-target="#modalA" href="#" style="font-size: 20px">《上海莫斯蒂恩网络科技有限公司·APS·ICAS》</a>
        </div>
        <div id="safeguardB" class="text-center show-acos">
            <h3>B客户端·保障协议</h3>
            <a class="btn" data-toggle="modal" data-target="#modalB" href="#" style="font-size: 20px">《上海莫斯蒂恩网络科技有限公司·BPS·ICAS》</a>
        </div>
        <div id="safeguardC" class="text-center show-acos">
            <h3>C客户端·保障协议</h3>
            <a class="btn" data-toggle="modal" data-target="#modalC" href="#" style="font-size: 20px">《上海莫斯蒂恩网络科技有限公司·CPS·ICAS》</a>
        </div>
        <div class="project_menu text-center pt-60 pb-40">
            <h3>SEID</h3>
            <ul>
        ...
        <div id="dataShowA" class="text-center col-lg-8 offset-lg-2">
            <h3>数据加密算法</h3>
            <a class="btn" data-toggle="modal" data-target="#modaldataA" href="#"
               style="font-size: 20px">《上海莫斯蒂恩网络科技有限公司·ICSE·SEID》</a>
        </div>
        <div id="dataShowB" class="text-center show-acos">
            <h3>大数据分析算法</h3>
            <a class="btn" data-toggle="modal" data-target="#modaldataB" href="#"
        ...
        <div class="row">
            <div class="footer-flex">
                ...
                <div class="modal fade" id="report3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                中国日报9月8日电
                                9月7日，2019世界物联网博览会重要活动之一——2019世界物联网博览会新技术新产品新应用成果发布会在无锡举行。会上，中国经济信息社发布《2018-2019中国物联网发展年度报告》(下称《年报》)，系统分析全球物联网发展新态势，为业界、学界和政府提供重要参考。
                                ...
                                “无锡物联网”已成为中国在世界舞台上的鲜明标签，无锡“智慧城市”品牌进一步升级。2019年，无锡国家传感网创新示范区获批建设十周年。在部省市合力推动下，“无锡物联网”已成为中国物联网在世界舞台上的鲜明标签：一批技术标准引领全球，一批企业快速崛起，一批创新项目引领生产生活变革。无锡以物联网为核心的“智慧城市”品牌进一步升级：2018年入围全球智慧城市前20强；2019年获批成为全国首个国家级车联网先导区的城市。

                                《年报》认为，当前，我国物联网仍面临一些发展瓶颈：底层核心技术薄弱短板进一步凸显，标准互联互通、开放共享亟待强化，物联网应用深度、广度仍待拓展，数据隐私和物联网安全问题仍然突出等。

                                中国经济信息社是新华社经济信息事业的主体，秉承“服务经济建设中心工作、服务国家发展战略”的使命，持续跟踪研究物联网领域的发展动态，已连续九年发布《中国物联网发展年度报告》。中国经济信息社江苏中心将把无锡作为物联网产业的重要研究基地，继续研究并发布物联网系列信息智库产品。
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">关闭</button>
                            </div>
                ...
                <div class="modal fade" id="report4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                一我国区域经济发展的外部环境分析[1] (一)我国融入世界经济的进程加快中共中央
                                总书记胡锦涛在中共“十七大”报告中指出，“事实雄辩地证明， 改革开放是决定当
                                代中国命运的关键抉择，是发展中国特色社会主义、实现中华民族伟大复兴的必由之
                                路。”从改革开放之日起，我国就开始了逐步融入世界经济的进程。2001年12月11
                                日,我国正式加入了世界贸易组织。这意味着我国已经成了世界经济体系中的正式成
                                员。到2006年底，我国加入WT0五年过渡期结束。在这五年中，我国履行了加入wT0的.
                                所有承诺，清理了2000多份与贸易有关的法律法规，废除了其中700多份与WTO规则不
                                一致的法律法规。中国加入世贸组织五周年之际，世贸组织总干事拉米对中国的表现
                                给出了“A+”的评价。
                                加入wT0的五年，也是我国经济发展最快的时期。2006年我国国内生产总值就已经达
                                到20万亿元人民币;外汇储备突破10000亿美元。入世五年，我国对世界经济的贡献
                                已经占到13%的比重，跃升为第三大贸易国，第四大经济体。2007年三季度世界银行
                                发布的《中国经济季报》指出，2007年中国经济对世界GDP增长的贡献度有可能超过
                                美国，以中国为代表的新兴市场国家将成为全球经济“发动机”。
                                中国与世界贸易组织的蜜月期还没有结束，与多个贸易成员国的贸易摩擦就已经接踵
                                而来。根据wT0秘书处对2007年上半年各成员国的贸易纠纷调查报告:各成员国在此
                                期间内共发起49起反倾销调查，其中有16起针对中国出口产品。虽然这-数字比2006
                                年同期的31起下降了近一半，但中国仍然是反倾销调查的热点国家，是美国和欧盟反
                                倾销的主要目标《2007年中国五大反倾销案件盘点》，中国纺织网，2007年11月16
                                日。。在融入世界经济一体化过程中出现的这些问题与现象，要求我国的发展模式和
                                总体开放水平再跨上一个新台阶。
                ...
                <div class="modal fade" id="report5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                2018年，中国网贷交易额全球最高，达1789亿美元。自2018年起，P2P网贷频繁爆雷。2019年4月，中国P2P网贷新增问题平台超280家，占总体比例的21.5，近期的团贷网爆雷，涉事金额约145亿元，涉事投资者达22万。高额收益、浮夸宣传、借新还旧是问题平台通病。同时，P2P网贷平台爆雷可能波及上下游企业，如小米、邻家便利店。
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">关闭</button>
                            </div>
                    ...
                    <div class="modal fade" id="serve4" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    2017年底，越秀地产按照国内顶级云厂商的企业云化战略落地方案，启动了上云之路。莫斯蒂恩专家服务团队，
                                    为越秀地产提供了云化战略咨询服务。通过深刻分析越秀地产的业务现状和发展目标，
                                    莫斯蒂恩从云计算与新技术应用规划、架构、容器及微服务设计等，为越秀地产提供了云化战略方案和架构最佳实践指导。
                                    越秀地产需要共享业务架构， 这样的架构的好处在于，企业可以重用已有的服务，更快地通过共享服务的组合支撑新业务，降低试错成本。
                                    莫斯蒂恩采用了莫斯蒂恩公司内部多年进化和沉淀的企业级互联网架构，即微服务/服务化、
                                    分布式计算技术和共享中心化设计，为越秀地产规划构建平台化能力，通过共享服务的持续沉淀和滋养，
                                    打造业务生态圈，提升运营能力。
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">关闭</button>
                ...
                <div>
                    ...
                    <div class="footer-widget-list pt-30">
                        <ul>
                            <li><a class="navbar-brand" href="javascript:" data-toggle="modal"
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" align="center">
                    <h5 class="modal-title" id="exampleModalLabel">Mosidian</h5>
                    <div class="modal-header">
                        <img src="img/client/Apple.jpg" alt="Client">
                    </div>
                    <div class="modal-body">
                        <div class="client_text">
                            ...
                            <i class="fa fa-quote-left"></i>
                            <p>
                                2018年8月2日晚间，苹果盘中市值首次超过1万亿美元，股价刷新历史最高位至203.57美元。入选2019《财富》世界500强、2019福布斯全球数字经济100强榜第1位。</p>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">关闭</button>
        ...
        <div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="our_team pt-90 pb-50" data-scroll-index="6">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-8 offset-lg-2">
                                        <div class="section_title text-center">
                                            ...
                                            <div style="display: block;text-align: center">
                                                <img src="img/team/Able.jpg" width="100px" height="100px">
                                            </div>
                                            <h5>Able</h5>
                                            <span style="color: #1d91ff">联合创始人</span>
                                            <p>Able(杨震）熟练掌握JavaEE技术及架构体系、SpringMVC、Spring、 Mybatis、Redis、Spring
                                                Boot、Spring Cloud 等框架</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
