        ...
        <div class="card-body">
            ...
            <form id="form">
                <div class="row banner-cell">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label me-t-r"><span style="color: red">*</span>申请企业全称:</label>
                            <div class="col-sm-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label me-t-r"><span style="color: red">*</span>提供的服务：</label>
                            <div class="col-sm-9">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label me-t-r"><span style="color: red">*</span>负责人身份证号：</label>
                            <div class="col-sm-8">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label me-t-r"><span style="color: red">*</span>负责人电话：</label>
                            <div class="col-sm-9">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label me-t-r"><span style="color: red">*</span>负责人邮箱：</label>
                            <div class="col-sm-8">
